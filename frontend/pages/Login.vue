          ...
          <div class="login-wrapper my-auto">
            ...
            <form action="#!">
              <div class="form-group">
                ...
                <input type="text" class="form-control" v-model="username" @keyup.enter.prevent="logIn" />
              </div>
              <div class="form-group mb-4">
                <label for="password">Password</label>
                <input type="password" class="form-control" v-model="password" @keyup.enter.prevent="logIn" />
              </div>
              <input name="login" id="login" class="btn btn-block login-btn" type="button" value="LOGIN"
                @enter.prevent="logIn" @click.prevent="logIn" />
            </form>
          </div>
        </div>
